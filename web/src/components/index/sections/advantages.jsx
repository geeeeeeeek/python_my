...
const advantagesList = [
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-mainColorNormal">
        ...
        <section className="py-16 bg-mainColorLight">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Our Advantages</h2>
                    <p className="text-gray-600 max-w-3xl mx-auto mb-4 px-4">
                        With years of international trade experience and a professional team, we provide the most reliable products and services
                    </p>
                </div>
