export default function Testimonials() {
    ...
    return (
        <div className="bg-mainColor0 py-16 md:py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* 标题区域 */}
                <div className="text-center mb-12">
                    <div className="flex items-center justify-center mb-4">
                        <svg className="w-6 h-6 text-mainColor3 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" d="M18 5v8a2 2 0 01-2 2h-5l-5 4v-4H4a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2zM7 8H5v2h2V8zm2 0h2v2H9V8zm6 0h-2v2h2V8z" clipRule="evenodd"></path>
                        </svg>
                        <span className="text-sm font-semibold uppercase tracking-wider text-mainColor3">TESTIMONIALS</span>
                    </div>
