        ...
        <div className="bg-mainColorLight py-16 lg:py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <div
                        className="h-1 w-20 bg-gradient-to-r from-mainColorNormal to-mainColorNormal/50 mx-auto mb-6"></div>
                ...
                <div className="max-w-6xl mx-auto">
                    <div
                        ...
                        <div className="bg-gray-50 p-8 lg:p-12 relative">
                            ...
                            {/* 装饰背景元素 - 设置最低的z-index */}
                            <div
                                className="absolute top-0 right-0 w-32 h-32 bg-mainColorNormal/5 rounded-bl-full z-0"></div>
                            <div
                                className="absolute bottom-0 left-0 w-24 h-24 bg-mainColorNormal/5 rounded-tr-full z-0"></div>
                            ...
                            <div className="h-full flex flex-col relative z-10">
                                ...
                                <div className="space-y-8 mb-auto relative z-10">
                                    ...
                                    <div className="flex">
                                        <div
                                            className="w-12 h-12 rounded-full bg-mainColorNormal/10 flex items-center justify-center mr-4 shrink-0">
                                    ...
                                    <div className="flex">
                                        ...
                                        <div>
                                            <p className="text-gray-500 text-sm font-medium uppercase mb-1">PHONE
                                                NUMBER</p>
