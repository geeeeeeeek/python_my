  ...
  return (
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-12">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
              <h2 className="text-balance text-2xl font-semibold tracking-tight text-gray-900 sm:text-4xl">
                  From the blog
              </h2>
          ...
          <div className="mx-auto mt-16 grid container auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              {blogPosts.map((post) => (
                  <div
                      key={post.id}
                      className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80 transform transition-transform duration-300 hover:-translate-y-2"
                  >
