            ...
            >
                <div className="mx-auto max-w-7xl flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-3">
                        <a href={navSectionData['basicGlobal']['global_facebook']} target="_blank"
                        ...
                        <a href={navSectionData['basicGlobal']['global_twitter']} target="_blank"
                           className="hover:text-blue-100">
                            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                        ...
                        <a href={navSectionData['basicGlobal']['global_instagram']} target="_blank"
                           className="hover:text-blue-100">
                            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fillRule="evenodd"
                        ...
                        <a href={navSectionData['basicGlobal']['global_youtube']} target="_blank"
                           className="hover:text-blue-100">
                            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <ChevronDownIcon aria-hidden="true"
                                                         className="size-5 flex-none text-gray-400 group-hover:text-blue-500"/>
                                    </a>
