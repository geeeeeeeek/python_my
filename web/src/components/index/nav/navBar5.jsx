                    ...
                    <div className="hidden lg:flex items-stretch lg:gap-x-6">
                        {navigationItems.map((item) => (
                            item.type === 'link' ? (
                                ...
                                >
                                    <a className="px-4 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 cursor-pointer h-full flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900">
                                        {item.name}
                                        <ChevronDownIcon aria-hidden="true" className="size-5 flex-none text-gray-400 group-hover:text-blue-500"/>
                                    </a>
                                                    ...
                                                    <div className="grid grid-cols-1 gap-4">
                                                        {item.subItems.map((subItem) => (
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <div>
                                                                        <div className="text-sm font-semibold text-gray-900 group-hover:text-blue-600">{subItem.name}</div>
                                                                    </div>
                                                                </a>
                                                                    ...
                                                                    {activeSubMenu === subItem.name && subItem.subItems && (
                                                                        ...
                                                                        >
                                                                            {subItem.subItems.map((subSubItem) => (
                                                                                ...
                                                                                >
                                                                                    <div className="text-sm font-semibold text-gray-900 hover:text-blue-600">{subSubItem.name}</div>
                                                                                </a>
                                                                            ))}
                                                                        </motion.div>
                                                                    )}
