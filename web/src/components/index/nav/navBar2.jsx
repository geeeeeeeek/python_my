                        ...
                        {sectionData && sectionData.navigationItems.map((item) => (
                            item.type === 'link' ? (
                                <a
                                    key={item.name}
                                    href={item.href}
                                    className={`px-6 flex items-center justify-center ${current===item.href? 'bg-mainColor text-white':'text-gray-900'} hover:bg-mainColor hover:text-white transition-colors duration-200 text-sm/6 font-semibold`}
                                >
                                    {item.name}
                                </a>
                            ) : (
                                ...
                                >
                                    <a
                                        href={item.href}
                                        className={`px-6 ${current.indexOf(item.href)>=0 ? 'bg-mainColor text-white':'text-gray-900'} hover:bg-mainColor hover:text-white transition-colors duration-200 cursor-pointer h-full flex items-center gap-x-1 text-sm/6 font-semibold`}
                                    >
                                        {item.name}
                                        <ChevronDownIcon
                                            aria-hidden="true"
                                            ...
                                            <div className="grid grid-cols-1 gap-2">
                                                {item.subItems.map((subItem) => (
                                                    ...
                                                    >
                                                        <a
                                                            href={subItem.href}
                                                            className="flex items-center gap-x-4 rounded-md p-3 ${current===item.href? 'bg-mainColor text-white':'text-gray-900'}  hover:bg-mainColor hover:text-white transition-colors duration-200 group"
                                                        >
                                                            <div>
                                                            ...
                                                            >
                                                                {subItem.subItems.map((subSubItem) => (
                                                                    <a
                                                                        ...
                                                                        className="block rounded-md p-3 text-sm font-semibold ${current===item.href? 'bg-mainColor text-white':'text-gray-900'}  hover:bg-mainColor hover:text-white transition-colors duration-200"
                                                                    >
                                                                        <div>
                                                                            {subSubItem.name}
                                                                        </div>
