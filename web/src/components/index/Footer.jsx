                        ...
                        <ul className="space-y-3">
                            {
                                sectionData.navigationItems.map((item) => (
                                    <li key={item.name}>
                                        <a href={item.href}
                                           className="hover:text-mainColor transition flex items-center group">
                                        <span
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-mainColor"
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="h-5 w-5 flex-shrink-0 mr-3 text-mainColor" fill="none"
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mt-6">
                    ...
                    <div className="flex space-x-3 mt-4 md:mt-0">
                        <a  href={sectionData['basicGlobal']['global_twitter']} target="_blank"
                            className="text-gray-500 hover:text-mainColor transition-colors p-2 rounded-full hover:bg-gray-100">
