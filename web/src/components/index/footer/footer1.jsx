...
import InquiryForm from "@/components/index/inquiry/inquiryForm";
            ...
            <div className="container mx-auto px-6 md:px-12">
                        ...
                        <ul className="space-y-3">
                            {
                                sectionData.navigationItems.map((item) => (
                                    <li key={item.name}>
                                        <a href={item.href}
                                           className="hover:text-mainColor3 transition flex items-center group">
                                        <span
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-mainColor3"
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="h-5 w-5 flex-shrink-0 mr-3 text-mainColor3" fill="none"
                                ...
                                <span>
                                    ...
                                    <a
                                        ...
                                        className="hover:text-mainColor3 transition"
                                    >
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mt-6">
                    ...
                    <div className="flex space-x-3 mt-4 md:mt-0">
                        <a  href={sectionData['basicGlobal']['global_twitter']} target="_blank"
                            className="text-gray-500 hover:text-mainColor3 transition-colors p-2 rounded-full hover:bg-gray-100">
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                            </svg>
                        </a>
                        <a   href={sectionData['basicGlobal']['global_instagram']} target="_blank"
                           className="text-gray-500 hover:text-mainColor3 transition-colors p-2 rounded-full hover:bg-gray-100">
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a  href={sectionData['basicGlobal']['global_linkedin']} target="_blank"
                           className="text-gray-500 hover:text-mainColor3 transition-colors p-2 rounded-full hover:bg-gray-100">
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        {/* Facebook Icon */}
                        <a  href={sectionData['basicGlobal']['global_facebook']} target="_blank"
                           className="text-gray-500 hover:text-mainColor3 transition-colors p-2 rounded-full hover:bg-gray-100">
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        {/* YouTube Icon */}
                        <a  href={sectionData['basicGlobal']['global_youtube']} target="_blank"
                           className="text-gray-500 hover:text-mainColor3 transition-colors p-2 rounded-full hover:bg-gray-100">
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
